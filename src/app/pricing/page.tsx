...
export const metadata: Metadata = {
  title: "Pricing — Dse Hong Kong Premium",
  description: "Unlock unlimited Dse Hong Kong practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=dse-hong-kong&cadence=annual`;
