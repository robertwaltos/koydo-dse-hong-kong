// Auto-generated shim — re-exports from @/lib/dse-hong-kong/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _dse_hong_kong_Config } from "@/lib/dse-hong-kong/config";
import { EXAM_CONFIG as _raw } from "@/lib/dse-hong-kong/config";
